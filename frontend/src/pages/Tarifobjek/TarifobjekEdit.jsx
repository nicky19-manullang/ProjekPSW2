...
function TarifobjekEdit() {
  ...
  useEffect(() => {
    ...
    const fetchOptions = async () => {
      try {
        const [objekRes, jangkaRes, currentData] = await Promise.all([
        ...
        const formattedDate = new Date(currentData.data.data.tanggalDinilai).toISOString().split('T')[0];
    ...
    <div style={{ fontFamily: "'Poppins', sans-serif", padding: "20px", backgroundColor: "#f8fafc", minHeight: "100vh" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", backgroundColor: "white", borderRadius: "10px", boxShadow: "0 2px 10px rgba(0,0,0,0.05)", padding: "20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "600", color: "#1e293b" }}>Edit Tarif Objek Retribusi</h1>
          <button 
