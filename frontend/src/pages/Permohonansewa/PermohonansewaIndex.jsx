...
const Api_URL =  "http://127.0.0.1:8000/api/permohonan-sewa";
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{
          display: "grid",
          gridTemplateColumns: "0.5fr repeat(10, 1fr)",
          padding: "15px 20px",
          backgroundColor: "#4361ee",
          color: "white",
          fontWeight: "500",
        ...
        {currentItems.length > 0 ? (
          currentItems.map((item, index) => (
            ...
            >
              ...
              <div style={{ fontWeight: "500" }}>{item.id_jenis}</div>
              <div>{item.id_peruntukan}</div>
              <div>{item.id_objek_retribusi}</div>
              <div>{item.id_wajib_retribusi}</div>
              <div>{item.pemohon_sewa}</div>
              <div>{item.jenis_permohonan}</div>
              <div>{item.lama_sewa}</div>
              <div>{item.nomor_surat_permohonan}</div>
              <div>{item.status}</div>
