      ...
      <div style={{ 
        ...
        {currentUsers.length > 0 ? (
          currentUsers.map((user, index) => (
            ...
            >
              ...
              <div>{user.jangka_waktu_id}</div>
              <div>{user.jangka_waktu_sewa}</div>
        ...
        <div style={{ 
          ...
          <div style={{ color: "#64748b" }}>
            Menampilkan {currentUsers.length} dari {users.length} jangka waktu sewa
          </div>
          <div style={{ display: "flex", gap: "10px" }}>
            <button 
